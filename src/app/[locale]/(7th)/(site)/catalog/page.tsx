  ...
  return (
    <div className={style.section_1}>
      <div className={style.side_banner}>
        <Image
          src={'/src/images/@about/section01/side_banner.svg'}
          width={98}
          height={214}
          alt=""
        />
    ...
    <>
      ...
      <div className={style.ai_speak}>
        {isMobile ? (
          ...
          <>
            <Image
              src={'/src/images/@about/section04/img_speak.svg'}
              width={1754}
              height={974}
              alt=""
            />
      ...
      <div className={style.container}>
        <div className={style.header}>
          ...
          <div className={style.real_review_image}>
            <Image
              src={'/src/images/@about/section08/text_real_review.svg'}
              width={376}
              height={120}
              alt=""
            />
      ...
      <div>
        ...
        <div className={style.buttons}>
          ...
          <CategoryButton
            ...
            img="/src/images/@about/section09/ico_speak_icon.svg"
            txt_1="AI SPEAK"
