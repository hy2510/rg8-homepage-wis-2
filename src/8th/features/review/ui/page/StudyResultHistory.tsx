...
function StudyResultHistoryList({
  ...
  const historyTypeItems: ActionBarDropdownItem[] = [
    { key: 'HistoryTypeReading', label: t('t8th067'), isActive: true },
    { key: 'HistoryTypeSpeaking', label: t('t8th068'), isActive: false },
    { key: 'HistoryTypeWriting', label: t('t8th069'), isActive: false },
  ]
  ...
  const exportItems: ActionBarDropdownItem[] = [
    ...
    { key: 'ExportReport', label: t('t8th070'), isActive: true },
    { key: 'ExportWorksheets', label: t('t8th071'), isActive: true },
  ]
                  ...
                  <BoxStyle
                    ...
                    {item.list.map((history) => {
                      ...
                      const expendMenu: {
                        ...
                        : []
                      if (isBookInfoLoaded && !!bookInfo?.workSheetPath) {
                        expendMenu.push({
                          text: t('t8th059'),
                          onClick: () => {
