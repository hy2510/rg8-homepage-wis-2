...
function makeBookDetailInfo(json?: any): BookDetailInfo {
  return {
...
function transform(json: any): BookDetailInfoResponse {
  return makeBookDetailInfo(json)
}

export type BookDetailInfoParams = {
  levelRoundId: string
  studyId?: string
  studentHistoryId?: string
}

export type BookDetailInfoResponse = BookDetailInfo

export async function getBookDetailInfo(
  input: BookDetailInfoParams,
): Promise<BookDetailInfoResponse> {
